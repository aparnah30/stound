...
const Index = () => {
  const [selectedService, setSelectedService] = useState<'stocks' | 'bonds' | 'cash' | null>(null);
              ...
              {services.map((service) => {
                ...
                return (
                  <button
                    ...
                    className={`p-6 rounded-xl bg-gradient-to-br ${service.color} ${service.textColor} hover:shadow-[var(--shadow-elegant)] transition-all duration-300 transform hover:scale-105 group`}
                  >
