    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Rajesh Kumar", role: "CEO & Co-Founder", experience: "15+ years in Fintech" },
              { name: "Priya Singh", role: "CTO & Co-Founder", experience: "12+ years in Technology" },
              { name: "Amit Sharma", role: "Chief Investment Officer", experience: "20+ years in Investments" }
            ].map((member, index) => (
              <Card key={index} className="p-6 text-center hover:shadow-[var(--shadow-card)] transition-all duration-300">
